...
<body>
    ...
    <section class="hero">
        <h1>Kes me oleme?</h1>
        <p>Teie naabruskonna toidupood, mis pakub värskeid tooteid, suupisteid, jooke ja igapäevaseid tarbevahendeid.
            Oleme siin, et teenindada teid kvaliteetsete kaupade ja sõbraliku teenindusega.</p>
    </section>
        ...
        <div class="products">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="<?=htmlspecialchars($t['pilt'])?>" alt="<?=htmlspecialchars($t['n'])?>">
                </div>
